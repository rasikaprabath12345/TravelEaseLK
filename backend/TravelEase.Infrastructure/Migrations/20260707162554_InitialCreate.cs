        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_TourGuides_TourGuideId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportOrNIC = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "IsActive", "LastName", "PasswordHash", "PhoneNumber", "ProfileImage", "Role", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2026, 7, 7, 16, 25, 54, 387, DateTimeKind.Utc).AddTicks(6244), "admin@travelease.lk", "Admin", true, "User", "$2a$11$GM5qzRjxwEMVmBT7iASD/ejtpcZJP5IdlXCjDf0cZtfobrGqbhauS", null, null, "Admin", null });
