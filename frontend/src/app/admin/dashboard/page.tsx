...
import {
  ...
  AlertCircle, CheckCircle, Package as PkgIcon, Plus, Image as ImageIcon, Video
} from 'lucide-react';
...
const adminLinks = [
  ...
  { href: '/admin/blogs', label: 'Vlogs & Blogs', icon: Video, color: 'red', desc: 'Create & manage palace blogs/vlogs' },
